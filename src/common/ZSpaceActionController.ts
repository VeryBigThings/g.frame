...
export class ZSpaceActionController extends ActionController {
    ...
    /**
     * Initialises ZSpace events for ActionController
     * @param config Config for the class
     * @param zSpaceControls ZSpace controller which fires the events
     */
    ...
    /**
     * Function to unsubscribe ZSpaceActionController from all of the listened events
     */
    dispose() {
