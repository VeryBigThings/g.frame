...
export class VirtualKeyboardComponent extends GComponent {
    private letterKeyboard: GComponent;
    private symbolKeyboard: GComponent;

    private rightKeyboard: GComponent;
    private numberKeyboard: GComponent;

    private wordKeyboard: GComponent;
    ...
    private initWordKeyboard() {
        this.wordKeyboard = new GComponent();
    ...
    private initLetterKeyboard() {
        ...
        this.letterKeyboard = new GComponent();
        this.symbolKeyboard = new GComponent();
    ...
    private initNumberKeyboard() {
        ...
        this.numberKeyboard = new GComponent();
    ...
    private initRightKeyboard() {
        this.rightKeyboard = new GComponent();
